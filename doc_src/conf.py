...
version = geocamTrack.get_version()
# The full version, including alpha/beta/rc tags.
release = geocamTrack.get_version()
...
htmlhelp_basename = 'geocamTrackWebdoc'
...
latex_documents = [
    ('index', 'app.tex', u'geocamTrackWeb Documentation',
     u'Trey Smith', 'manual'),
]
